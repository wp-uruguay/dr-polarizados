...
export const metadata: Metadata = {
  ...
  description: "Política de privacidad de Dr Polarizados",
};
        ...
        <div className="container">
          ...
          <div style={{ marginTop: "2.5rem" }}>
            ...
            <ul>
              ...
              <li>Enviar comunicaciones de marketing (previa autorización)</li>
            </ul>

            <h2 style={{ marginTop: "2rem" }}>4. Base Legal del Tratamiento</h2>
            ...
            <ul>
              ...
              <li>Cookies de preferencias (guardar tus selecciones)</li>
